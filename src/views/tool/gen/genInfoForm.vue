...
const rules = ref({
  ...
  packageName: [{ required: true, message: " Please Input 生成包路径", trigger: "blur" }],
  moduleName: [{ required: true, message: " Please Input 生成模块名", trigger: "blur" }],
  businessName: [{ required: true, message: " Please Input 生成业务名", trigger: "blur" }],
  functionName: [{ required: true, message: " Please Input 生成功能名", trigger: "blur" }]
});
