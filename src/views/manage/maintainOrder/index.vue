  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="orderRef" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="order code" prop="code">
          <el-input v-model="form.code" placeholder="请输入order code" />
        </el-form-item>
        <el-form-item label="status" prop="status">
        ...
        <el-form-item label="auto generated" prop="isAutoGenerated">
          <el-radio-group v-model="form.isAutoGenerated">
            <el-radio v-for="dict in is_auto_generated" :key="dict.value" :label="parseInt(dict.value)">{{ dict.label
              }}</el-radio>
          </el-radio-group>
        </el-form-item>
...
const data = reactive({
  ...
  queryParams: {
    ...
    status: null,
    params: {
      parentTypeId: 0,  // parentTypeId of maintenance order is 1.
    },
  },
