  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="user" align="center">
        <template #default="scope">
          <span>{{ empList.find(item => item.id === scope.row.userId)?.userName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="type" align="center">
        <template #default="scope">
          <span>{{ orderTypeList.find(item => item.id === scope.row.typeId)?.name }}</span>
        </template>
      </el-table-column>
...
import { listTechnicianByInnerCode } from "@/api/manage/emp";
  ...
  proxy.$refs["orderRef"].validate(valid => {
    if (valid) {
      if (form.value.id != null) {
        updateOrder({
          id: form.value.id,
          createType: 0,// maintenance order is 0
